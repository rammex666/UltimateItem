...
public class SQLiteManager {
    ...
    public void initialize() {
        try (Connection connection = getSQLConnection()) {
            ...
            UltimateItem.instance.getLogger().log(Level.SEVERE, "Unable to retrieve connection", ex);
        }
    }
    ...
    public static Connection getSQLConnection() {
        ...
        if (!folder.exists()) {
            try {
                ...
                UltimateItem.instance.getLogger().log(Level.SEVERE, "File write error: " + dbName + ".db");
            }
        }
        try {
            ...
            UltimateItem.instance.getLogger().log(Level.SEVERE, "SQLite exception on initialize", ex);
        }
        return null;
    }
